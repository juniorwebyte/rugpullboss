      ...
      const checkTransaction = async () => {
        try {
          ...
          if (receipt) {
            ...
            // Adicionar reivindicação ao banco de dados
            try {
              await addClaim({
              ...
              console.error("Erro ao adicionar reivindicação:", claimError)
              // Continue mesmo se houver erro ao adicionar a reivindicação
            }
