  ...
  useEffect(() => {
    ...
    const runSecurityChecks = async () => {
      ...
      const isDomainCorrect =
        window.location.hostname === "rugpullboss.com" ||
        window.location.hostname === "www.rugpullboss.com" ||
        window.location.hostname === "presale.rugpullboss.com" ||
        window.location.hostname === "airdrop.rugpullboss.com" ||
        window.location.hostname === "192.168.100.102:3000" ||
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              {!securityChecks.domainVerified && <li>Este não é o domínio oficial do RugPullBoss</li>}
