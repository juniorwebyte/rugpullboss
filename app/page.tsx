...
export default function Home() {
  ...
  // Adicionar estado para controlar o pop-up após a declaração de useState para isWalletConnected
  const [showUniversePopup, setShowUniversePopup] = useState(false)

  // Adicionar useEffect para mostrar o pop-up após um tempo
  useEffect(() => {
    const timer = setTimeout(() => {
      // Verificar se o usuário já viu o popup antes
  ...
  return (
    <main className="flex min-h-screen flex-col bg-black text-white relative overflow-hidden">
      <PortalAnimation />
      <FloatingElements lowPerformanceMode={localStorage.getItem("lowPerformanceMode") === "true"} />
