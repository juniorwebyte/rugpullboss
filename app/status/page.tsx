            ...
            {claimData.status === "not_found" ? (
              <CardContent className="p-6">
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <h3 className="text-xl font-medium text-orange-300 mb-2">Invocação Não Encontrada</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-fuchsia-900/10 border border-fuchsia-800/20 rounded-lg p-4">
                        ...
                        <p className="text-lg font-bold text-fuchsia-300">
                          {claimData.tokensAllocated.toLocaleString()} $RPBOSS
                        </p>
                      </div>
                      <div className="bg-fuchsia-900/10 border border-fuchsia-800/20 rounded-lg p-4">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-fuchsia-900/10 border border-fuchsia-800/20 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-fuchsia-300">{stats.totalClaims.toLocaleString()}</p>
                </div>
                <div className="bg-fuchsia-900/10 border border-fuchsia-800/20 rounded-lg p-4">
                  <p className="text-sm text-gray-400">Invocações Processadas</p>
                  <p className="text-2xl font-bold text-green-300">{stats.processedClaims.toLocaleString()}</p>
                </div>
                <div className="bg-fuchsia-900/10 border border-fuchsia-800/20 rounded-lg p-4">
                  <p className="text-sm text-gray-400">Tokens Invocados</p>
                  <p className="text-2xl font-bold text-fuchsia-300">
                    {stats.tokensDistributed.toLocaleString()} $RPBOSS
                  </p>
                </div>
              </div>
            </CardContent>
